...
(function(global, $) {
     ...
     */
    var cssMap = {
        '.toast-message': '{position:fixed;left:50%;top:50%;transform:translateX(-50%);border:1px solid #EBEEF5;min-width:350px;transition:top .3s ease-out;opacity .3s ease-out;padding:15px 15px 15px 20px;display:flex;align-items:center;z-index:2000;margin-top: 20%;}',
        ...
        '.toast-message .toast-message__content': '{padding-right:10px;line-height: 24px;}',
        ...
        '.toast-message--danger': '{border-color:#d43f3a;background-color:#d9534f;}',
        '.toast-message--danger .toast-icon': '{margin-right:16px;}',
        '.toast-message--danger .toast-message__content': '{color:#fff;}',
